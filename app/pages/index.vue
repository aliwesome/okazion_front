    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
      ...
      <div class="bg-card border border-border rounded-lg p-6">
        ...
        <div class="space-y-3">
          ...
          <div>
            <NuxtImg
              src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=200&h=100&fit=crop"
              alt="Code"
              width="200"
              height="100"
      ...
      <div class="bg-card border border-border rounded-lg p-6">
        ...
        <div class="space-y-2">
          <p class="text-sm">
            Mouse position:
            <span class="font-mono">{{ mouse.x }}, {{ mouse.y }}</span>
          </p>
          <p class="text-sm">
            Online:
        ...
        <div class="space-y-3">
          <div>
            ...
            <div class="space-y-1">
              ...
              <Badge variant="info" size="sm">ESLint</Badge>
              <Badge variant="info" size="sm">Prettier</Badge>
            </div>
          </div>
          <div>
...
useSeoMeta({
  title: "Home - Nuxt 4 Starter Kit",
  ogTitle: "Home - Nuxt 4 Starter Kit",
  description:
    "Welcome to the Nuxt 4 starter kit - a production-grade starter with TypeScript, Tailwind CSS v4, and modern tooling",
  ogDescription:
    "Welcome to the Nuxt 4 starter kit - a production-grade starter with TypeScript, Tailwind CSS v4, and modern tooling",
});
</script>
